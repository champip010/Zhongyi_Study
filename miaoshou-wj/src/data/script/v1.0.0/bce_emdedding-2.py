...
# DEV
BCE_URL_LIST = 'http://172.16.44.174:9998/list/encode'
BCE_URL = 'http://172.16.44.174:9998/encode'
...
if __name__ == '__main__':
    ...
    total_token = 0
    folder_path = "G://20万文献数据_json//output_4"

    total_token = 0
    with open("arxiv1_complete_file_output4.txt", "a+") as f:
        f.seek(0)
        x = f.readlines()
